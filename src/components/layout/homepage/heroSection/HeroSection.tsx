...
const Staggered = ({ text, inview }: IProp) => {
  ...
  return (
    <motion.h1
      ...
      className="scroll-m-20 font-TenorSans min-[1800px]:text-[70px] min-[900px]:text-[50px] max-[900px]:text-[40px] font-medium tracking-tight min-[1200px]:leading-[80px] max-[1200px]:leading-[60px] min-[1800px]:leading-[90px] min-[1500px]:text-[60px] max-[700px]:text-center max-[700px]:mx-auto  max-[700px]:w-full"
    >
      {text}
    </motion.h1>
  );
