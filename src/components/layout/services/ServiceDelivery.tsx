...
const ServiceDelivery: React.FC = () => {
  ...
  return (
    <div>
      <div className="min-[1800px]:w-[1500px] w-[85%] mx-auto my-[50px] flex max-[700px]:flex-col justify-between items-center gap-[40px]">
        <div
          ref={ref}
          className=" flex flex-col gap-3 w-[500px] max-[700px]:w-full"
        >
          <h1 className="flex flex-col gap-2 scroll-m-20 text-3xl txt-[#433E3E] font-semibold tracking-tight first:mt-0 font-tenorSans ">
