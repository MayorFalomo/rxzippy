      ...
      <div>
        ...
        >
          <h1 className="flex flex-col gap-[1px] items-start justify-center h-full w-[70%] max-[500px]:w-[85%] m-auto text-white text-[60px] max-[900px]:text-[50px] max-[700px]:text-[40px] leading-[70px] max-[600px]:leading-[50px] font-stinger scroll-m-20 font-bold tracking-wide">
            ...
            <span>Delivery</span>
            <span className=" h-[1px] mt-2 w-[300px] max-[400px]:w-[100px] bg-white"></span>
          </h1>
        </div>
        <div className=" my-[50px] mx-auto w-[70%] max-[800px]:w-[90%]">
          <Texts className=" text-offGray leading-7" size="md">
            RxZippy is a company founded in Atlanta, GA, with its primary
            purpose of delivering medical supplies across a significant part of
            the state. Always with the intention of expanding its reach to
            ...
            Although our company is over 97% focused on medical services, we are
            also open to new opportunities.
          </Texts>
