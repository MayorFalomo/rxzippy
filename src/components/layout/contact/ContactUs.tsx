...
const ContactUs: React.FC = () => {
  return (
    <div className=" ">
      <div className="h-[80vh] max-[750px]:h-auto">
        <div className="my-[30px] flex justify-center mx-auto min-[600px]:hidden">
          <TrackYourPackageBtn />
        </div>
        <div className="flex items-center justify-center h-full">
          <div className="flex max-[750px]:flex-col items-center justify-between gap-[20px] w-[85%] max-[480px]:w-[95%] mx-auto">
            <div className="flex flex-col  w-full max-[750px]:mt-[20px] gap-6">
              <h1 className="scroll-m-20 text-4xl font-extrabold font-hkGrotesk text-[#433E3E] tracking-tight lg:text-5xl">
                Get In touch
              </h1>
            ...
            <div className="flex flex-col gap-4 max-[750px]:mb-[20px] ">
              <div>
                <h2 className="scroll-m-20 font-semibold font-stinger tracking-wide  text-[#433E3E] text-[36px] max-[600px]:text-[24px] first:mt-0">
                  Give us a call{" "}
                </h2>
                <Texts className=" text-[#433E3E] font-light">
